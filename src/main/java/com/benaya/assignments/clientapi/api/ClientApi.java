...
public interface ClientApi {
    ...
    @ApiResponse(responseCode = "200", description = "Fetched clients successfully",
            content = { @Content(mediaType = "application/json", schema = @Schema(implementation = Client.class)) })
    Page<Client> getClientsByName(@Parameter(description = "Name of the client to be fetched") @RequestParam String name);
    ...
    Page<Client> getClientsByFirstName(@Parameter(description = "First name of the client to be fetched") @RequestParam String firstName);

    @Operation(summary = "Get clients by last name")
    @ApiResponse(responseCode = "200", description = "Fetched clients successfully", content = { @Content(mediaType = "application/json", schema = @Schema(implementation = Client.class)) })
    Page<Client> getClientsByLastName(@Parameter(description = "Last name of the client to be fetched") @RequestParam String lastName);

    @Operation(summary = "Get clients by IP address")
    @ApiResponse(responseCode = "200", description = "Fetched clients successfully", content = { @Content(mediaType = "application/json", schema = @Schema(implementation = Client.class)) })
    Page<Client> getClientsByIp(@Parameter(description = "IP address of the client to be fetched") @RequestParam String ip);

    @Operation(summary = "Get clients by phone number")
    @ApiResponse(responseCode = "200", description = "Fetched clients successfully", content = { @Content(mediaType = "application/json", schema = @Schema(implementation = Client.class)) })
    Page<Client> getClientsByPhone(@Parameter(description = "Phone number of the client to be fetched") @RequestParam String phone);

    @Operation(summary = "Get clients by email address")
    @ApiResponse(responseCode = "200", description = "Fetched clients successfully", content = { @Content(mediaType = "application/json", schema = @Schema(implementation = Client.class)) })
    Page<Client> getClientsByEmail(@Parameter(description = "Email address of the client to be fetched") @RequestParam String email);
